...
renderPlot({
  ...
  p <- ggplot(prdplo(), aes(x = date)) + 
    geom_point(data = rawvalue(), aes(y = log10(value)), size = 0.5) +
...
renderPlot({
  ...
  p <- ggplot() + 
    ...
    geom_point(data = rawvalue, aes(x = date, y = log10(value)), size = 0.5) +
...
renderPlot({
  ...
  # aggregated data
  toplo <- extractPeriodAverages(modin, rawvalue, dytr[1], dytr[2])
...
renderPlot({
  ...
  req(prdplok1())
  rawvalue <- modsk1()$data[[1]]

  p <- ggplot() + 
    geom_point(data = rawvalue, aes(x = dec_time, y = log10(value)), size = 0.5) +
